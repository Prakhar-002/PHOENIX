                              ...
                              <div className="flex flex-col  gap-2 max-w-[480px] w-full mx-auto">
                                    ...
                                    >
                                          ...
                                          <TextField
                                                ...
                                                label='Email'
                                                placeholder='Email'
                                                helperText='The verification link sent to your email address wilt be valid for 1 hour.'
                                                required={true}
                                                autoFocus={true}
                                          />
                                    ...
                                    <p className="text-bodyMedium text-light-onSurfaceVariant dark:text-dark-onSurfaceVariant
                                          ...
                                          <Link
                                                to='/login'
                                                className="link text-labelLarge inline-block me-1 text-light-onSurface dark:text-dark-onSurface"
                                          >
                                                Login
                                          </Link>
                                    </p>
