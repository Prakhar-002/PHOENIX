...
const App = () => {
  ...
  */
  ...
  /*
    ...
    * and 'toggle-Sidebar' is a function to toggle the sidebar.
  */
  ...
  */
  ...
  -----
  - Inside the hook, we get the current HTML element referenced by V chatHistoryRef' .
  -----
  - Then, we check if is true, indicating that a new message is being loaded.
  -----
  ...
  */
  ...
  /*
  ? Check if the current navigation state is ' loading' and
  if there is no form data associated with the navigation.

  ? This condition typically signifies a normal page load,

  ? where the page is loading for the first time or is
        ...
        <div className="h-dvh grid grid-rows-[max-content,minmax(0,1fr),max-content]">
          ...
          <div className="bg-light-background dark:bg-dark-background">
            <div className="max-w-[870px] px-5 w-full mx-auto">
              ...
              >
                Phoenix may display inaccurate info,
                including about people, so double-check its
                responses.
                <a
