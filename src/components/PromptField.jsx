...
const PromptField = () => {
      ...
      const moveCursorToEnd = useCallback(() => {
            ...
            // C tear existing selections and add the new range
      ...
      // Defines a Framer Motion variant for the prompt field,
      // controlling its animation based on its visibility state.
      ...
      // Defines a Framer Motion variant for the prompt field
      // children, controlling its animation based on its visibility state.
